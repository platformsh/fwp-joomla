class JConfig {
    ...
    public $offline_image = 'images/joomla_mnt.png';
    public $sitename = 'Mon Site Joomla';
    public $editor = 'jce';
    ...
    public $mailonline = '1';
    public $mailer = 'mail';
    public $mailfrom = 'test@oleane-hebergement.com';
    public $fromname = 'Support Technique Caen';
    ...
    public $MetaDesc = 'Mon site joomla';
    public $MetaKeys = '';
    public $MetaTitle = '1';
    public $MetaAuthor = '1';
